        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-24 mb-20">
            ...
            <div className="space-y-6">
                <Link href="/" className="inline-block">
                    <h2 className="font-serif text-3xl text-primary">Holistic Rising</h2>
                </Link>
                ...
                <p className="text-muted-foreground text-sm uppercase tracking-wider font-semibold">
                    London <span className="text-primary mx-1">•</span> Essex <span className="text-primary mx-1">•</span> Dubai
                </p>
            </div>
            ...
            {/* Column 3: Resources */}
            <div className="space-y-6">
                <h3 className="font-serif text-sm font-bold uppercase tracking-widest text-foreground">Resources</h3>
                <ul className="space-y-4 text-muted-foreground text-sm font-sans">
                    <li><Link href="/blog" className="hover:text-primary transition-colors">Blog</Link></li>
                    <li><Link href="/aftercare" className="hover:text-primary transition-colors">Aftercare & Policies</Link></li>
             ...
             {/* Column 4: Connect */}
            <div className="space-y-6">
                <h3 className="font-serif text-sm font-bold uppercase tracking-widest text-foreground">Connect</h3>
                <ul className="space-y-4 text-muted-foreground text-sm font-sans">
                    <li><Link href="/find-us" className="hover:text-primary transition-colors">Find Us</Link></li>
                    <li><Link href="/team" className="hover:text-primary transition-colors">Meet the Team</Link></li>
                    <li><Link href="/policies" className="hover:text-primary transition-colors">Policies</Link></li>
                </ul>
